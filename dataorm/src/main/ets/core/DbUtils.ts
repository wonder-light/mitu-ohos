 ...
 *
 * Based on DbUtils.java written by
...
export class DbUtils {
  ...
  public static async executeSqlScriptTr(resourceMgr: any, db: Database, rawFilename: string,
    transactional: boolean): Promise<number> {
  ...
  public static getEntityClassName(entityCls: any): string {
    return Reflect.getMetadata('EntityClass', entityCls)
  }
}
