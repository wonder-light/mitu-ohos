 ...
 *
 * Based on InternalUnitTestDaoAccess.java written by
...
export class InternalUnitTestDaoAccess<T, K> {
  ...
  public readEntity(cursor: relationalStore.ResultSet, offset: number): T {
    return this.dao.readEntity(cursor, offset);
  }

  public readKey(cursor: relationalStore.ResultSet, offset: number): K {
